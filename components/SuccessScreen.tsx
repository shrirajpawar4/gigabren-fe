        ...
        <div className="space-y-4 mb-6">
          <div className="bg-[#1A1C23] p-4 rounded-lg">
            ...
            <a 
              ...
              className="text-emerald-400 hover:text-emerald-300 font-mono text-sm break-all transition-colors"
            >
              {transactionHash}
            </a>
          </div>
          ...
          <div className="bg-[#1A1C23] p-4 rounded-lg">
            ...
            <p className="text-emerald-400 font-mono text-sm">{balance?.toString() || '0'} Pass</p>
          </div>
        </div>

        <div className="flex flex-col gap-3">
          <a
            href={`https://gigabrain.gg/login`}
            target="_blank"
            rel="noopener noreferrer"
